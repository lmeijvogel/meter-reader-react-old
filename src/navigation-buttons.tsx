...
export default class NavigationButtons extends Component<IProps, {}> {
  render() {
    ...
    const todayButton = <NavigationButton label="Today" onClick={() => this.newPeriod(today)} enabled={this.props.enabled} />
    ...
    return <div className="container">
             ...
             {up && <div className="row">
                      <div className="column column-100">
                        <NavigationButton label={up.toShortTitle()} onClick={() => this.newPeriod(up)} enabled={this.props.enabled} />
                      </div>
                    </div>}
