...
@observer
export class PeriodUsageDisplay extends React.Component<
  IPeriodUsageDisplayProps,
  {}
> {
  render() {
    ...
    const data = dataShifter.call(
      dataProvider.periodUsage,
      dataProvider.positionInData
    );

    return (
      <div
        className={
          "PeriodUsageDisplay" + (this.props.enabled ? "" : " disabled")
        }
      >
        <Chart
          label="Gas"
